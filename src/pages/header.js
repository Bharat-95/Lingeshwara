...
const header = () => {
  return (
    <div className="flex bg-gradient-to-r from-blue-950 to-blue-600 h-16 lg:w-auto md:w-auto w-auto justify-between items-center lg:px-16 md:px-16 px-4 space-x-4">
      ...
      <div >
        ...
        <Link href="/categories" className="hover:text-gray-400 lg:text-lg md:text-sm text-[10px]"> <li>Categories</li></Link>
